export default {
  ...
  'consent.scope.openid': 'Authenticate using your AGI-chat account',
  ...
  'consent.thirdParty.notice':
    'This application is created by a third-party developer and is not operated by AGI-chat. Once authorized, it can act on your behalf and use your account quota.',
