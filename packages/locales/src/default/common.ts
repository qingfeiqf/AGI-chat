export default {
  ...
  'messengerBanner.title': 'Talk to AGI-chat AI on your favorite messaging apps',
  ...
  'cmdk.askLobeAI': 'Ask AGI-chat AI',
  ...
  'taskTemplate.action.create.success': 'Scheduled task added. Find it in AGI-chat AI.',
