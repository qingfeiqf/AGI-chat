export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to AGI-chat. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc': 'No bot setup. Chat with AGI-chat on Slack, Discord, Telegram.',
  ...
  'channel.connectionError.connection_closed':
    'The platform connection was interrupted. AGI-chat will try to reconnect automatically.',
  ...
  'channel.connectionError.upstream_unavailable':
    'The platform service is temporarily unavailable. AGI-chat will try again later.',
  ...
  'channel.imessage.description':
    'Connect this agent to iMessage through the local AGI-chat Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in AGI-chat Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and AGI-chat Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, AGI-chat Desktop receives local BlueBubbles webhooks and forwards them to AGI-chat.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to AGI-chat. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to AGI-chat. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to AGI-chat, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The AGI-chat Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between AGI-chat Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
