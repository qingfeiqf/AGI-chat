export default {
  ...
  'action.create.success': 'Scheduled task added. Find it in AGI-chat AI.',
  ...
  'headline-inspiration.instruction':
  ...
  'viral-content-breakdown.instruction':
  ...
  'twitter-weekly-recap.instruction':
  ...
  'youtube-weekly-recap.instruction':
  ...
  'competitor-creator-tracking.instruction':
  ...
  'content-calendar-weekly.instruction':
  ...
  'vercel-health-weekly.instruction':
  ...
  'linear-sprint-daily.description':
    'Each morning, sync sprint progress: blockers, overdue items, today’s focus — ready before standup.',
  'linear-sprint-daily.instruction':
  ...
  'daily-design-inspiration.instruction':
  ...
  'design-trend-weekly.instruction':
  ...
  'figma-files-cleanup.instruction':
  ...
  'aigc-prompt-inspiration.instruction':
  ...
  'brand-watch-weekly.instruction':
  ...
  'arxiv-curated-daily.instruction':
  ...
  'must-read-papers-weekly.instruction':
  ...
  'language-morning-bite.instruction':
  ...
  'industry-research-weekly.instruction':
  ...
  'industry-morning-brief.instruction':
  ...
  'competitor-radar-daily.instruction':
  ...
  'funding-intel-daily.instruction':
  ...
  'macro-economy-weekly.instruction':
  ...
  'weekly-meeting-brief.instruction':
    'Every Monday at 08:30, prepare 3 talking points for this week’s strategy meeting: industry trends, internal metrics worth raising, and decisions that need to be made.',
  ...
  'marketing-hot-radar.instruction':
  ...
  'ad-creative-inspiration.instruction':
  ...
  'brand-mention-daily.instruction':
    'Every evening at 18:00, summarize today’s mentions of my tracked brands and keywords on X (Twitter): volume, sentiment, top voices. Flag any unusual spikes.',
  ...
  'newsletter-perf-weekly.instruction':
  ...
  'kol-collab-calendar.description':
    'Every Monday, sync ongoing KOL collabs: who’s due, who’s overdue, performance so far.',
  'kol-collab-calendar.instruction':
    'Every Monday at 09:00, review the KOL collabs I’m running: who’s due to post, who’s overdue, and performance numbers for completed posts.',
  ...
  'hubspot-funnel-daily.instruction':
  ...
  'user-feedback-daily.instruction':
  ...
  'competitor-update-daily.instruction':
  ...
  'standup-brief.description':
    'Each morning before standup, pull a Linear progress brief: today’s focus, blockers, yesterday done.',
  'standup-brief.instruction':
    'Every morning at 08:30, pull a Linear progress brief: today’s focus, blockers, what I closed yesterday. Format as 3 bullets ready to read aloud at standup.',

  'iteration-recap-weekly.title': 'Iteration recap weekly',
  'iteration-recap-weekly.description':
    'Every Friday afternoon, this iteration’s data: completion rate, overdue items, new bugs.',
  'iteration-recap-weekly.instruction':
    'Every Friday at 17:00, recap this week’s iteration: completion rate, overdue items, new bugs filed. Format ready to drop into Monday’s retrospective.',
  ...
  'user-interview-schedule.description':
    'Every Monday, walk through this week’s interviews: who, when, are the questions ready.',
  'user-interview-schedule.instruction':
    'Every Monday at 09:00, list this week’s scheduled user interviews: participant name, time, prep checklist (questions ready, recording set up).',

  'prd-review-reminder.title': 'PRD review reminder',
  'prd-review-reminder.description':
    'Every Friday, list PRDs due for review this week — don’t leave docs stuck in draft.',
  'prd-review-reminder.instruction':
  ...
  'daily-followup-list.instruction':
  ...
  'renewal-risk-weekly.description':
    'Every Monday, flag this month’s renewals — especially accounts with declining usage.',
  'renewal-risk-weekly.instruction':
  ...
  'deal-pipeline-weekly.instruction':
  ...
  'zendesk-ticket-daily.instruction':
  ...
  'morning-brief.description':
    'Every day at 8: today’s schedule, pending email count, todos, weather. Read on the way in.',
  'morning-brief.instruction':
    'Every morning at 08:00, send me: today’s calendar, pending email count, top 3 todos, and weather. Format as a 1-minute read.',
  ...
  'calendar-conflict-check.instruction':
    'Every morning at 07:30, scan today’s calendar for conflicts, back-to-back meetings, or insufficient travel/buffer time. Suggest fixes.',

  'friday-wrap-list.title': 'Friday wrap list',
  'friday-wrap-list.description':
    'Every Friday afternoon: what didn’t finish, what ships Monday, the first thing for next week.',
  'friday-wrap-list.instruction':
    'Every Friday at 16:00, list: what I didn’t finish this week, what needs to ship Monday, and the first thing I should pick up next week.',
  ...
  'recruit-funnel-daily.instruction':
  ...
  'onboarding-buddy-weekly.instruction':
  ...
  'team-status-weekly.instruction':
    'Every Monday at 09:00, review the team’s past week: PTO, overtime hours, meeting load. Flag anyone trending toward burnout.',
  ...
  'precious-metals-daily.instruction':
  ...
  'cashflow-weekly.description':
    'Every Monday, what’s coming in this week, what’s going out, large expenses next week.',
  'cashflow-weekly.instruction':
  ...
  'contract-expiry-weekly.instruction':
  ...
  'regulation-watch-weekly.instruction':
  ...
  'invoice-collection-daily.instruction':
  ...
  'cross-platform-engagement-daily.instruction':
  ...
  'brand-collab-weekly.instruction':
  ...
  'follower-growth-weekly.instruction':
  ...
  'youtube-channel-weekly.instruction':
  ...
  'monetization-opportunity-weekly.instruction':
  ...
  'crypto-market-daily.instruction':
  ...
  'child-growth-weekly.description':
    'Tell me your child’s age — every Monday, this week’s development focus + activity ideas.',
  'child-growth-weekly.instruction':
    'Every Monday at 09:00, give me development focus areas appropriate for my child’s age this week, plus parent-child activity ideas and things to watch for.',

  'child-study-weekly.title': 'Child study weekly',
  'child-study-weekly.description':
    'Tell me what your child is studying — every Sunday, this week’s progress + next week’s focus.',
  'child-study-weekly.instruction':
    'Every Sunday at 20:00, recap my child’s study progress this week and identify focus areas for next week. Suggest practice activities for each subject.',

  'family-finance-weekly.title': 'Family finance weekly',
  'family-finance-weekly.description':
    'Every Sunday night, this week’s spending breakdown, budget completion, next week’s big expenses.',
  'family-finance-weekly.instruction':
  ...
  'family-task-schedule.instruction':
  ...
  'diet-log-companion.instruction':
  ...
  'podcast-new-episodes.description':
    'Tell me your subscribed podcasts — every Monday, this week’s new episodes + 3 worth listening.',
  'podcast-new-episodes.instruction':
  ...
  'newsletter-aggregator.instruction':
  ...
  'series-update-weekly.description':
    'Tell me what you’re following — each week, episode/chapter updates and quick recaps.',
  'series-update-weekly.instruction':
    'Every Monday at 09:00, give me update notices and a short recap for the shows, novels, or comics I’m following.',
  ...
  'travel-inspiration-weekly.instruction':
  ...
  'exhibition-event-weekly.description':
    'Tell me your city — every Monday, this week’s exhibitions, performances, and live shows.',
  'exhibition-event-weekly.instruction':
    'Every Monday at 10:00, list this week’s exhibitions, performances, and livehouse shows in my city. Add quick context for the most interesting ones.',
  ...
  'daily-learning-bite.instruction':
