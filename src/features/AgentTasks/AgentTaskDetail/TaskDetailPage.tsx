...
interface TaskDetailPageProps {
  /** Suppress the NavHeader chrome — used by hosts that render their own header (e.g. the AgentTasks modal). */
  hideHeader?: boolean;
  showTaskAgentPanelToggle?: boolean;
  taskId: string;
}

const TaskDetailPage = memo<TaskDetailPageProps>(
  ({ taskId, showTaskAgentPanelToggle = true, hideHeader = false }) => {
